...
def backward():
    ...
    data = Data(config.train_file, config.class_num, config.batch_size, config.anchors, config.multi_scale_img)
    ...
    feature_y1, feature_y2, feature_y3 = yolo.forward(inputs, isTrain=True)
